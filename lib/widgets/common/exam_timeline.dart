...
class ExamTimelineWidget extends StatefulWidget {
  final VoidCallback? onTap;
  final VoidCallback? onLongPress;

  const ExamTimelineWidget({super.key, this.onTap, this.onLongPress});

  @override
  State<ExamTimelineWidget> createState() => _ExamTimelineWidgetState();
}

class _ExamTimelineWidgetState extends State<ExamTimelineWidget> {
