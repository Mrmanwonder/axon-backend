...
"""
    ...
    async def grade_typed_answer(
        ...
        *,
        ...
        if not student_answer.strip():
            return self._get_empty_answer_response(
                objective=objective,
        ...
        prompt = self._build_grading_prompt(
            ...
            command_word_depth=command_word_depth,
            semantic_match=semantic_match,
        )

        parsed = await self._generate_json(prompt, "Gemini typed grading failed")
        return self._process_grading_response(
            parsed=parsed,
            available_marks=available_marks,
            command_word_depth=command_word_depth,
            semantic_match=semantic_match,
    ...
    def _get_empty_answer_response(
        self,
        *,
        objective: str,
        command_word: str,
...
"""
    ...
    def _process_grading_response(
        self,
        *,
        parsed: dict[str, Any],
        available_marks: int | float | None,
        command_word_depth: dict[str, Any],
        semantic_match: dict[str, Any],
    ) -> dict[str, Any]:
