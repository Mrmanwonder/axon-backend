...
"""
    ...
    def _fetch_objective(self, objective_id: str) -> dict[str, Any]:
        # Performance optimization: batch objective fetching using Or filter
        # Reduces DB roundtrips from potentially 2 to exactly 1.
        filter_1 = FieldFilter("objective_id", "==", objective_id)
        filter_2 = FieldFilter("code", "==", objective_id)
